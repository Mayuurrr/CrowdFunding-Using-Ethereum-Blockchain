    ...
    <main>
      <div className="flex gap-4 md:flex-row flex-col">
        ...
        <div className="flex flex-col sm:flex-row md:flex-col justify-between gap-4">
          <div className="rounded-lg bg-neutral-800 min-w-[124px] w-full">
            ...
            <p className="bg-neutral-700 w-full rounded-b-lg p-2 text-sm text-white text-center">
      ...
      <div className={`grid gap-4 ${getDaysLeft(campaign?.deadline) > 0 ? 'grid-cols-1 md:grid-cols-4' : 'grid-cols-1'}`}>
        <div className="col-span-4 md:col-span-3">
          <div className="mt-8">
            <h4 className="text-xl text-black font-semibold uppercase mb-2">Creator</h4>
            <div className="flex items-center gap-2">
              <Image
                ...
                height={48}
              />
              <p className="truncate text-black">{campaign?.owner}</p>
            </div>
          </div>
          <div className="mt-8">
            <h4 className="text-xl text-black font-semibold uppercase mb-2">Story</h4>
            <p className="text-black">{campaign?.description}</p>
          </div>
          <div className="mt-8">
            <h4 className="text-xl text-black font-semibold uppercase mb-2">
              Top Donations
            </h4>
