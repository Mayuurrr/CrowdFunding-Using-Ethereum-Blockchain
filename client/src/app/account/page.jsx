    ...
    <main>
      <div className="bg-neutral-800 rounded-lg w-full p-4">
        ...
        <div className="flex flex-col my-4">
          ...
          <span className="text-white truncate">{signer?.address}</span>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 items-center justify-between gap-4">
          <div className="flex flex-col gap-2">
            <span className="text-white">Number of Campaigns:</span>
            <span className="text-white">{campaigns?.length ?? 0}</span>
          </div>
          <div className="flex flex-col gap-2">
            <span className="text-white">Total Collected:</span>
            <span className="text-white">{totalCollected}</span>
          </div>
          <div className="flex flex-col gap-2">
            <span className="text-white">Total Withdrawn:</span>
            <span className="text-white">{totalWithdrawn}</span>
          </div>
        </div>
      </div>
      <div className="mt-4">
        {campaigns?.length === 0 ? (
          <div className="flex flex-col  justify-center gap-4 mt-10">
            <h1 className="text-xl text-black">No Campaigns Found</h1>
