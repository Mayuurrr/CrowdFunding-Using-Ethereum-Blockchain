...
const Create = () => {
  ...
  return (
    <main className="w-full p-5px bg-white rounded-lg min-h-[calc(100vh-96px)]">
      <div className="m-auto w-content flex justify-center items-center p-4">
        <h1 className="bg-black py-8 px-16 text-2xl font-bold rounded-lg text-center w-content mx-auto">
          Start a Campaign
        </h1>
      </div>
      <form
      ...
      >
        ...
        />
        <div className="flex items-center justify-around gap-4 bg-emerald-500 p-4 md:p-8 rounded-lg text-white">
